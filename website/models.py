...
class Foods(db.Model):  # type: ignore
    ...
    alpha_carotene = db.Column(Float)
    b12 = db.Column(Float)
    b6 = db.Column(Float)
    beta_carotene = db.Column(Float)
    biotin = db.Column(Float)
    c = db.Column(Float)
    calcium = db.Column(Float)
    carbohydrate = db.Column(Float)
    carotene = db.Column(Float)
    chloride = db.Column(Float)
    cholesterol = db.Column(Float)
    copper = db.Column(Float)
    d = db.Column(Float)
    e = db.Column(Float)
    energy = db.Column(Float)
    fat = db.Column(Float)
    fibre = db.Column(Float)
    folate = db.Column(Float)
    iodine = db.Column(Float)
    iron = db.Column(Float)
    k1 = db.Column(Float)
    lutein = db.Column(Float)
    lycopene = db.Column(Float)
    magnesium = db.Column(Float)
    manganese = db.Column(Float)
    mono = db.Column(Float)
    n_3 = db.Column(Float)
    n_6 = db.Column(Float)
    niacin = db.Column(Float)
    niacin_equivalent = db.Column(Float)
    pantothenate = db.Column(Float)
    phosphorus = db.Column(Float)
    poly = db.Column(Float)
    potassium = db.Column(Float)
    protein = db.Column(Float)
    retinol = db.Column(Float)
    retinol_equivalent = db.Column(Float)
    riboflavin = db.Column(Float)
    satd = db.Column(Float)
    selenium = db.Column(Float)
    sodium = db.Column(Float)
    thiamin = db.Column(Float)
    trans = db.Column(Float)
    tryptophan_60 = db.Column(Float)
    zinc = db.Column(Float)
